...
public class XdsRequestBuilderService {
    ...
    /**
     * Build a {@link ProvideAndRegisterDocumentSet} based on {@link CdaDocumentMetadata} and document payload
     */
    public ProvideAndRegisterDocumentSetRequest buildProvideAndRegisterDocumentSetRequest(String documentId, String documentPayload, DocumentMetadata cdaDocumentMetadata) {
        ...
        Document document = new Document(documentEntry, new DataHandler(new ByteArrayDataSource(documentPayload.getBytes(), cdaDocumentMetadata.getMimeType())));
