...
public class ServiceStarter {
    ...
    private static final Logger serviceLogger = LoggerFactory.getLogger("kih-xds-generator");
    ...
    public GenericContainer<?> startServicesInDocker() {
        ...
        var resourcesContainerName = "kih-xds-generator-resources";
        ...
        if (resourcesRunning) {
            ...
            service = new GenericContainer<>("local/kih-xds-generator-qa:dev")
        ...
        service.withNetwork(dockerNetwork)
                .withNetworkAliases("kih-xds-generator")
